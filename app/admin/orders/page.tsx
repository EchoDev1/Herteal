    ...
    <div className="space-y-6">
      ...
      {isViewModalOpen && selectedOrder && (
        <div className="fixed inset-0 bg-black/50 flex items-start justify-center z-50 p-2">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[calc(100vh-1rem)] flex flex-col">
            {/* Modal Header */}
            ...
            {/* Modal Footer */}
            <div className="flex-shrink-0 bg-gray-50 border-t border-gray-200 p-6 flex justify-end rounded-b-lg">
              <button
                onClick={() => setIsViewModalOpen(false)}
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 bg-black/50 flex items-start justify-center z-50 p-2">
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[calc(100vh-1rem)] flex flex-col">
            <div className="flex-shrink-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between rounded-t-lg">
            ...
            <form onSubmit={(e) => { e.preventDefault(); handleSaveNewOrder(); }} className="flex-1 min-h-0 p-6 space-y-6 overflow-y-auto">
